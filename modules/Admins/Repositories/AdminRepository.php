...
class AdminRepository extends BaseRepository
{
    ...
    {
        try {
           $admins = Admin::with('country')->with('city')->get();
            return $this->ApiResponse(Response::HTTP_OK, 'message',Null,$admins);
        } catch (Exception $e) {
            return $e;
           // return $this->ApiResponse(Response::HTTP_NO_CONTENT, 'No data provided');
        }
    }
...
//        }
    ...
    {
        if ($admin->trashed()) {
            return $this->ApiResponse(Response::HTTP_NOT_FOUND, 'this Admin was deleted');
        }
        try{
            $profile = Admin::find($admin->id);
            $profile->makeHidden(['password']);
        }catch (Exception $e) {
            return $this->ApiResponse(Response::HTTP_NOT_FOUND, 'can not Find Admin Data');
        }
